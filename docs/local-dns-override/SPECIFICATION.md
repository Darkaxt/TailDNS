...
The feature covers Android and a Windows shared-core/companion path. Both implementations and their primary real-device/host workflows now exist; final cross-platform reconciliation, production release publication and post-release automation remain governed by Stages 5–7. The current repository state is not yet the public feature release.
